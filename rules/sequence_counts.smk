...
rule prepare_clade_data:
    ...
    params:
        ...
        clade_min_count = lambda wildcards: _get_prepare_data_option(wildcards, 'clade_min_count'),
        clade_min_freq = lambda wildcards: _get_prepare_data_option(wildcards, 'clade_min_freq'),
        clade_min_count_days = lambda wildcards: _get_prepare_data_option(wildcards, 'clade_min_count_days'),
    ...
    shell:
        ...
        python ./scripts/prepare-data.py \
            ...
            {params.clade_min_count} \
            {params.clade_min_freq} \
            {params.clade_min_count_days} \
